class CrudNotificationMailer < ApplicationMailer 
  ...
  def update_notification(object)
    ...
    mail to: 'admin@example.com', subject: "An entry from #{object.class} has been updated"
  end
  ...
  def delete_notification(object)
    ...
    mail to: 'admin@example.com', subject: "An entry from #{object.class} has been deleted"
  end
end
